...
exports.excluirMultiplas = async (request, response) => {
    ...
    // Extraindo os códigos e tipos das eletivas
    ...
    try {
        // Buscar todos os alunos matriculados nas eletivas de uma só vez
        ...
        // Desmatricular alunos encontrados, se houver
        if (alunosData && alunosData.length > 0) {
            ...
            // Executar todas as desmatrículas em paralelo
            try {
