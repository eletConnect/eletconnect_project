...
// Supondo que você tenha uma função no backend como esta:
exports.listarEletivasTodosAlunos = async (req, res) => {
    ...
    try {
      ...
      // Buscar as eletivas associadas aos alunos
      ...
      // Adicionar eletivas aos alunos
      const alunosComEletivas = alunosData.map((aluno) => ({
        ...aluno,
        eletivas: eletivasPorAluno[aluno.matricula] || [], // Se não tiver eletivas, retorna array vazio
      }));
