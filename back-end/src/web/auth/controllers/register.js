...
exports.register = async (request, response) => {
    ...
    try {
        ...
        const confirmationLink = `http://localhost:5173/confirmar-conta?tkn=${token}`;
        ...
        try {
            await resend.emails.send({
                from: '"eletConnect" <no-reply@eletconnect.com>', // Altere para o e-mail de remetente desejado
                to: email,
