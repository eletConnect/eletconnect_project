...
exports.login = async (request, response) => {
    ...
    try {
        ...
        request.session.user = { id: user.id, matricula: user.matricula, nome: user.nome, email, status: user.status, cargo: user.cargo, avatar: user.avatar, instituicao: user.instituicao };  
