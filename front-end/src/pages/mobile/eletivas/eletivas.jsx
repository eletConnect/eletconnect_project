...
export default function MHome() {
        ...
        setFiltroDia(prev => {
            if (abaSelecionada === 'Trilha') {
                if (prev.includes(dia)) {
                    ...
                    return [...prev, dia]; // Permitir múltiplos dias para "Trilha"
                }
            } else {
                return prev.includes(dia) ? [] : [dia]; // Permitir apenas um dia para outras abas
            }
        });
    }, [abaSelecionada]);
    ...
    // Reiniciar filtros ao trocar de aba
    useEffect(() => {
        setFiltroDia([]);
        setFiltroHorario('');
    }, [abaSelecionada]);
