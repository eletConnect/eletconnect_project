...
export default function Home() {
        ...
        const fetchData = async () => {
            try {
                ...
                if (resposta.status === 200) {
                    ...
                    // Definir estilos e cores para os gráficos
                    ...
                    // Encontrar o maior valor entre as categorias para definir o máximo dos gráficos
                    ...
                    // Configurações do gráfico de Alunos
                    ...
                    // Configurações do gráfico de Eletivas
    ...
    ], [totalAlunos, totalTurmas, totalEletivas, totalProjetosVida, totalTrilhas, totalColaboradores]);
