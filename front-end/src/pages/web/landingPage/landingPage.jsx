    ...
    return (
        <>
            <nav className="navbar fixed-top bg-body-tertiary">
                <div className="container-fluid" style={{ margin: "0 10em" }}>
                    ...
                    <div className="d-flex align-items-center">
                        ...
                        <Link className="btn btn-primary" to={"/login"}><i className="bi bi-person-fill"></i></Link>
                    </div>
                </div>
            </nav>
            <main>
                <section id='painel' className='container-fluid'>
                    <div className="row text-white" style={{ padding: '7.2em' }}>
