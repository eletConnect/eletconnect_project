...
export default function Colaboradores() {
    ...
    const listarColaboradores = async () => {
        try {
            const response = await axios.post('/colaborador/listar', { instituicao: escola.id });
    ...
    const cadastrarColaborador = async (e) => {
        ...
        try {
            await axios.post('/colaborador/cadastrar', { matricula, nome, email, cargo, instituicao: escola.id });
