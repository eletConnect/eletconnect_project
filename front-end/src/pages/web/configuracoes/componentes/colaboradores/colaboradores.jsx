...
export default function Colaboradores() {
    ...
    const excluirColaborador = async () => {
        try {
            await axios.post('/colaboradores/excluir', { matricula: matriculaParaExcluir, instituicao: escola.cnpj });
            showToast('Colaborador excluído com sucesso', 'success');
            listarColaboradores(); // Atualiza a lista de colaboradores após a exclusão
        } catch (error) {
            showToast('Erro ao excluir o colaborador', 'error');
        }
    };
                                        ...
                                        <tr key={index}>
                                            ...
                                            <td className='text-end'>
                                                <div className="d-flex align-items-center justify-content-end gap-3">
                                                    ...
                                                    <button className='btn btn-sm btn-danger d-flex align-items-center gap-2' data-bs-toggle="modal" data-bs-target="#excluirColaborador" onClick={() => { setMatriculaParaExcluir(item.matricula); setNomeParaExcluir(item.nome); }}>
            ...
            <div className="modal fade" id="editarColaborador" tabIndex="-1" aria-labelledby="editarColaboradorLabel" aria-hidden="true">
                <div className="modal-dialog modal-lg">
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            <EditarColaborador matricula={matriculaParaEditar} /> {/* Aqui passamos a matrícula para o componente de edição */}
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="modal fade" id="excluirColaborador" tabIndex="-1" aria-labelledby="excluirColaboradorLabel" aria-hidden="true">
                <div className="modal-dialog">
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            <p>Tem certeza que deseja excluir o colaborador <strong>{nomeParaExcluir}</strong>?</p>
                        </div>
                        <div className="modal-footer">
                            <button type="button" className="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                            <button type="button" className="btn btn-danger" onClick={excluirColaborador} data-bs-dismiss="modal">Excluir</button>
                        </div>
                    </div>
                </div>
            </div>
