...
export default function SettingsInstituicao() {
    ...
    const alterarInstituicao = async (e) => {
        ...
        try {
            const response = await axios.post('http://localhost:3001/instituicao/alterar', { cnpj: escola.cnpj, nome: eNome, cep: eCep, endereco: eEndereco, telefone: eTelefone, logotipo: logotipoUrlAtualizado });
            if (response.status === 200) {
