    ...
    const cadastrarColaborador = async (e) => {
        ...
        try {
            ...
            if (response.status === 200) {
                ...
                listarColaboradores();
                setDadosColaborador({ matricula: '', nome: '', email: '', cargo: '' });
            } else {
                                            ...
                                            {paginatedData.length > 0 ? (
                                                paginatedData.map((item, index) => (
                                                    <tr key={index}>
                                                        ...
                                                        <td>{item.nome}&emsp;{item.matricula === user.matricula && ( <i className="bi bi-star-fill text-warning"></i> )}</td>
                                                        <td>{item.cargo}</td>
                                                        <td className='text-end'>
                                                            <div className="d-flex align-items-center justify-content-end gap-3">
                                                                ...
                                                                <button className='btn btn-sm btn-danger d-flex align-items-center gap-2' data-bs-toggle="modal" data-bs-target="#excluirColaborador" onClick={() => { setMatriculaParaExcluir(item.matricula); setNomeParaExcluir(item.nome); }} disabled={item.matricula === user.matricula} >
                    ...
                    <div className="modal-content">
                        ...
                        <form onSubmit={cadastrarColaborador}>
                            ...
                            <div className="modal-footer">
                                ...
                                <button type='submit' className='btn btn-primary' disabled={carregando}>{carregando ? 'Cadastrando...' : 'Cadastrar'}</button>
                            </div>
                        </form>
                    </div>
                </div>
