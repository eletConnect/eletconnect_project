...
export default function Colaboradores() {
    ...
    const user = JSON.parse(sessionStorage.getItem('user')); // Usuário logado
    const escola = JSON.parse(sessionStorage.getItem('escola')); // Escola atual
    ...
    // Funções de manipulação de colaboradores
    ...
    // Funções de seleção de colaboradores
