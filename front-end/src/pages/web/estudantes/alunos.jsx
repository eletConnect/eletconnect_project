...
export default function Alunos() {
    ...
    const cadastrarAluno = async (e) => {
        ...
        const novoAluno = { instituicao: escola.cnpj, matricula, nome: e.target.nome.value, serie: e.target.serie.value, turma: e.target.turma.value, senha: senhaPadrao };
