...
const Alunos = () => {
    ...
    const listarAlunos = async () => {
        try {
            const response = await axios.post('http://localhost:3001/estudantes/listar', { instituicao: escola.cnpj });
    ...
    const cadastrarAluno = async (e) => {
        ...
        try {
            const responseAluno = await axios.post('http://localhost:3001/estudantes/cadastrar', {
    ...
    const redefinirSenha = async (e) => {
        ...
        try {
            const response = await axios.post('http://localhost:3001/estudantes/redefinir-senha', { matricula: matriculaParaEditar, senha });
            if (response.status === 200) {
    ...
    const excluirAluno = async (e) => {
        ...
        try {
            const response = await axios.post('http://localhost:3001/estudantes/excluir', { matricula: matriculaParaEditar });
            if (response.status === 200) {
