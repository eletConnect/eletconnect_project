...
export default function EditarAluno() {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            const response = await axios.post(`http://localhost:3001/aluno/editar`, {
                    ...
                    <div className="w-75">
                        <form className="row g-3">
                            ...
                            <div className="col-md-6">
                                ...
                                <input type="text" className="form-control" id="validationCustom03" value={aEmail} onChange={e => setAEmail(e.target.value)} required />
                            </div>
