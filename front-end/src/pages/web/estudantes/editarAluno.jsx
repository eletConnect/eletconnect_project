...
export default function EditarAluno() {
    ...
    const URLmatricula = searchParams.get('matricula') || '';
    ...
    const carregarDadosAluno = async () => {
        try {
            const resposta = await axios.post(`/estudantes/consultar`, { matricula: URLmatricula });
    ...
    const carregarEletivasAluno = async () => {
        try {
            const resposta = await axios.post(`/eletivas/listar-eletivas-aluno`, { matricula: URLmatricula, instituicao: dadosAluno.instituicao });
            ...
            console.error('Erro ao buscar as eletivas do aluno:', erro);
    ...
    const aoSalvar = async () => {
        ...
        try {
            ...
            const resposta = await axios.post(`/estudantes/editar`, {
                matriculaAntiga: URLmatricula, // Use a matrícula atual que veio da URL
                matriculaNova: dadosAluno.matricula,  // Use a nova matrícula que o usuário pode ter editado
            ...
            <div className="box">
                <div className='m-4 d-flex gap-4'>
                    <div className="d-flex flex-column align-items-center gap-3">
                        <img width={300} height={400} src={dadosAluno.fotoUrl} alt="Foto do aluno" />
                    ...
                    <div className="w-75">
                        <form className="row g-3">
                            <div className="col-md-4">
                                ...
                                <input type="text" className="form-control" id="matricula" value={dadosAluno.matricula} onChange={e => setDadosAluno({ ...dadosAluno, matricula: e.target.value })} required aria-required="true" />
                            </div>
