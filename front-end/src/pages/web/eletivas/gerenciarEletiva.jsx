...
const GerenciarEletiva = () => {
    ...
    const [isLoadingModal, setIsLoadingModal] = useState(false); // Estado de carregamento do modal
    ...
    const listarTodosAlunos = async () => {
        ...
        try {
            setIsLoadingModal(true); // Inicia o carregamento do modal
            ...
            setIsLoadingModal(false); // Finaliza o carregamento do modal
        }
    };
                        ...
                        {!isLoading && (
                            <div className='d-flex gap-2'>
                                ...
                                <button className='btn btn-outline-secondary' data-bs-toggle="modal" data-bs-target="#gerarLista">
                                    <i className="bi bi-file-earmark-ruled"></i> Gerar lista
                                </button>
                            </div>
                        )}
                    </div>
