...
const GerenciarEletiva = () => {
    ...
    const carregarAlunosEletiva = async (userSession) => {
        try {
            const { data } = await axios.post('/eletivas/listarAlunosEletiva', { instituicao: userSession.instituicao, codigo: codigoEletiva });
            if (data?.length > 0) {
                setState(prevState => ({
                    ...prevState,
                    alunos: data,
    ...
    const handleMatricula = async () => {
        ...
        try {
            await axios.post('/eletivas/matricularAluno', { instituicao: user.instituicao, codigo: codigoEletiva, matricula: state.selectedAluno.matricula });
    ...
    const handleDesmatricular = async () => {
        ...
        try {
            await axios.post('/eletivas/desmatricularAluno', { instituicao: user.instituicao, codigo: codigoEletiva, matricula: state.alunoParaDesmatricular.matricula });
