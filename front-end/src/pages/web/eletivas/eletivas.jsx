                                ...
                                <tbody>
                                    {paginatedData.length > 0 ? paginatedData.map((item, index) => (
                                        <tr key={index}>
                                            ...
                                            <td><p className='m-0'>{item.dia}</p></td>
                                            <td><p className='m-0'>{item.horario}</p></td>
                            ...
                            <div className="modal-body">
                                ...
                                <div className="mb-3">
                                    ...
                                    <select className="form-select" id="tipo" value={tipo} onChange={(e) => setTipo(e.target.value)} >
                                        <option value="Eletiva" selected>Eletiva</option>
                                        <option value="Projeto de Vida">Projeto de Vida</option>
                                        <option value="Trilha">Trilha</option>
                                    </select>
                                </div>
                                <div className="mb-3">
                                    <label htmlFor="tipo" className="form-label"> Dia da semana <a className='text-danger'>*</a></label>
                                    <select className="form-select" id="dia" value={dia} onChange={(e) => setDia(e.target.value)} >
                                        <option value="d1" selected>Segunda-feira</option>
                                        <option value="d2">Terça-feira</option>
                                        <option value="d3">Quarta-feira</option>
                                        <option value="d4">Quinta-feira</option>
                                        <option value="d5">Sexta-feira</option>
                                        <option value="d6">Segunda-feira e Quarta-feira</option>
                                        <option value="d7">Terça-feira e Quinta-feira</option>
                                        <option value="d8">Quarta-feira e Sexta-feira</option>
                                        <option value="d9">Quinta-feira e Sexta-feira</option>

                                    </select>
                                </div>
                                <div className="mb-3">
                                    <label htmlFor="tipo" className="form-label"> Horário <a className='text-danger'>*</a></label>
                                    <select className="form-select" id="horario" value={horario} onChange={(e) => setHorario(e.target.value)} >
                                        <option value="h1" selected>Segunda-feira / 1º e 2º horário</option>
                                        <option value="h2">Terça-feira / 1º e 2º horário</option>
                                        <option value="h3">Quarta-feira / 1º e 2º horário</option>
                                        <option value="h4">Quinta-feira / 1º e 2º horário</option>
                                        <option value="h5">Sexta-feira / 1º e 2º horário</option>
                                    </select>
                                </div>
                                <div className="mb-3">
