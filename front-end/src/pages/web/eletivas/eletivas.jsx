                ...
                <div className="modal-dialog">
                    <div className="modal-content">
                        ...
                        <form onSubmit={excluirEletiva}>
                            <div className="modal-body">
                                <p>Tem certeza que deseja excluir a eletiva <strong>{eletivaSelecionada.nome}</strong>?</p>
                            </div>
                            <div className="modal-footer">
                                <button type="button" className="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            <form onSubmit={handleSalvarPeriodo}>
                                <div className="mb-3">
                                    <label htmlFor="dataInicio" className="form-label">Início do período de inscrições das eletivas</label>
                                    <input type="datetime-local" className="form-control" id="dataInicio" value={dataInicio} onChange={e => setDataInicio(e.target.value)} required />
                                </div>
                                <div className="mb-3">
                                    <label htmlFor="dataFim" className="form-label">Fim do período de inscrições das eletivas</label>
