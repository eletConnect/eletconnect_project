...
import SettingPerfil from "./pages/web/configuracoes/componentes/perfil";
import SettingSegurancao from "./pages/web/configuracoes/componentes/seguranca";
import Instituicao from "./pages/web/configuracoes/componentes/instituicao/editarInstituicao"
import SettingInstituicao from "./pages/web/configuracoes/componentes/instituicao/editarInstituicao";
...
const routers = createBrowserRouter([
    ...
    { path: '/settings/institution', element: <SettingInstituicao />},
    { path: '/institution', element: <Instituicao /> },
