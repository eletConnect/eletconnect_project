...
import EditarEletiva from "./pages/web/eletivas/editarEletiva";
import GerenciarEletiva from "./pages/web/eletivas/gerenciarEletiva";
...
import EditarSenha from "./pages/web/auth/changePassword";
...
import AlterarSenha from "./pages/web/auth/changePassword";
import Verificacao from "./pages/web/auth/verification";

// -- Páginas MOBILE --------------------
import MLogin from "./pages/mobile/auth/login";
import MEsqueciSenha from "./pages/mobile/auth/forgotPassword";
import MAlterarSenha from "./pages/mobile/auth/changePassword";
import MVerificacao from "./pages/mobile/auth/verification";

import MHome from "./pages/mobile/home/home";

import MEletivas from "./pages/mobile/eletivas/eletivas";
import MMinhaseletivas from "./pages/mobile/eletivas/minhasEletivas";
...
const routers = createBrowserRouter([
    ...
    { path: '/student/edit', element: <EditarAluno /> },

    { path: '/electives', element: <Eletivas /> },
    { path: '/electives/edit', element: <EditarEletiva /> },
    { path: '/electives/manage', element: <GerenciarEletiva /> },
    ...
    { path: '/m/electives', element: <MEletivas /> },
    { path: '/m/my-electives', element: <MMinhaseletivas /> },

    { path: '/m/login', element: <MLogin /> },
    { path: '/m/forgot-password', element: <MEsqueciSenha/> },
    { path: '/m/change-password', element: <MAlterarSenha /> },
    { path: '/m/verification', element: <MVerificacao /> },
